class armoryScene extends Phaser.Scene {
	...
	preload() {
		...
		this.load.image('enter', 'static/images/armoryScene/enter.jpg');
	}
	create() {
		...
		this.layer1_btn1.on('pointerdown', (pointer) => {
			...
			if (this.prop1.texture.key == 'w') {
				...
				} else if (blockData[curIndex] == 'block_1_4') {
	...
	block1() {
		...
		var data2 = ['block_1_1', 'block_1_2', 'block_1_3', 'block_1_4', 'block_1_5', 'block_1_6', 'block_1_1', 'block_1_2', 'block_1_3', 'block_1_4', 'block_1_5', 'block_1_6', 'block_2_1', 'block_2_2', 'block_2_3', ];
		data2.push(data1[0]);
		data2.push(data1[1]);
		data2.sort(function() {
			return Math.random() > 0.5 ? -1 : 1;
